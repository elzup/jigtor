// Flat line icons (Feather / react-icons "Fi" style) as a React component. The
// path data mirrors the vanilla shell so the visual language is unchanged.
export const ICON = {
  folder:
...
export function Icon({ name, className }: IconProps) {
  return (
    <svg
      ...
      className={className ? `jt-icon ${className}` : 'jt-icon'}
      aria-hidden="true"
